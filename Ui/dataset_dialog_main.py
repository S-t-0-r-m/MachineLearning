...
class DatasetDialog(QtWidgets.QDialog):
    ...
    def set_path_in_line_edit_with_file_browser(self):
        filepath = QtWidgets.QFileDialog.getOpenFileName(self, "Open file", "C:\\Users\\sbues\\VSCode\\python\\Regression\\datasets", "CSV files (*.csv)")[0]
    ...
    def create_datframe(self):
        try:
            ...
            self.dataset.set_up(self.path, "None", self.ui.comBoxSep.currentData(), True)
        except TypeError:
